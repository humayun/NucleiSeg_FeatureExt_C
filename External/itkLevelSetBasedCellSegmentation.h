...
#include "itkNoVerifyInputInformationGeodesicActiveContourLevelSetImageFilter.h"
...
public:
  ...
  typedef NoVerifyInputInformationGeodesicActiveContourLevelSetImageFilter< ImageType, ImageType >	GeodesicActiveContourFilterType;
  typedef Statistics::NormalVariateGenerator GeneratorType;

  typedef BinaryThresholdImageFilter<ImageType,CompImageType>		ThresholdingFilterType;
  typedef DanielssonDistanceMapImageFilter< ImageType,ImageType >	DistanceFilterType;
  typedef ImageRegionIterator< CompImageType>						CompIteratorType;
  typedef ImageRegionIterator< ImageType >							IteratorType;
  typedef CastImageFilter< CompImageType, TOutputImage >			OutputCastType;
...
protected:
  ...
  ~LevelSetBasedCellSegmentation() {}
  CompImagePointer Threshold( ImagePointer input,
  								double thresh_low,
  								double thresh_high,
  								unsigned int in_value,
  								unsigned int out_value );
  CompImagePointer GAC( ImagePointer speed,
  						int NumOfCells,
  						ImageIndexType start,
  						ImageSizeType size );
  CompImagePointer Resample (CompImagePointer input,

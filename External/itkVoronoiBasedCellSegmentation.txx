...
//  converter->SetOutputBackgroundValue( 0 );
    ...
    label++)
  {
    ...
    if ( labelObject->Size() > m_MinComponentSize )
    {
      ...
      m_ROIfilter1->SetRegionOfInterest( labelObject->GetBoundingBox() );
      m_ROIfilter1->Update();
      roiComp = m_ROIfilter1->GetOutput();

      m_ROIfilter2->SetRegionOfInterest( labelObject->GetBoundingBox() );
      m_ROIfilter2->Update();
      ...
      IteratorType vIt( voronoi,labelObject->GetBoundingBox() );
